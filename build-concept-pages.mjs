...
/* the 2026 exam pass, in the same purple language as the pricing card (KW:PASS4) — purple is the pass,
   brat is the action, so this never competes with the button above it */
...
/* specificity 0,4,0 so it beats .passbox's own display:grid when the sale closes */
